    ...
    <x-table>
        ...
        <div class="px-4 py-6 flex items-center">
            ...
            <x-jet-input type="text" class="flex-1 mr-5 rounded-full w-full p-3 text-2xl"
                placeholder="Escriba el nombre de la materia" wire:model="buscar" />
                ...
                <tbody>
                    @foreach ($materias as $materia)
                        <tr class="mx-4 my-4 bg-gray-200">
                            ...
                            <td>
                                <form class="my-4">
                                    <a class="btn btn-dark btn-md" href="" style="background-color:#050505;color:#ffff">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-dark btn-md" href="" style="background-color:#22c55e;color:#ffff">
                                        <i class="fa fa-whatsapp" aria-hidden="true"></i>
                                    </a>
                                    <a class="btn btn-dark btn-md" href="" style="background-color:#0284c7;color:#ffff">
