              ...
              <tr class="mx-4 my-4 divide-y divide-gray-200 bg-white">
                ...
                <td class="px-8 py-4">
                  ...
                  <td class="my-3 inline-flex justify-center px-6 py-4 whitespace-nowrap flex">
                    <form>
                            <a wire:click.prevent="habilitar({{$estudiante->id}})" class="ml-2 font-bold text-white rounded cursor-pointer bg-gray-600 hover:bg-gray-700 py-2 px-4" href="" style="background-color:#050505;color:#ffff">
                                @if (!$estudiante->estado)
                        ...
                        <button wire:click.prevent="eliminar({{$estudiante->id}})" class="ml-2 font-bold text-white rounded cursor-pointer bg-red-600 hover:bg-red-500 py-2 px-4"
